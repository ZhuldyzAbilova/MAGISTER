...
final master = Image.asset('mastercard.png',
    width: 50, package: 'img');
final visa = Image.asset('visacard.png',
    width: 50, package: 'img');
final discover = Image.asset('discover.png',
    width: 50, package: 'img');

final amex = Image.asset('amex.png',
    width: 50, package: 'img');
